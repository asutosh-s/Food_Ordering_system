...
<div class="container">
  <div class="row">
    ...
    <div class="col-sm-4" style="padding:30px;">
	   <div class="form-group">
           <i class="fa fa-phone" aria-hidden="true"></i>&nbsp;<b>31457823545</b><br><br>
			<i class="fa fa-home" aria-hidden="true"></i>&nbsp; 35-C ,Sector 9,Near Bigmart,Bangalore,india Zip Code-800000<br>(24*7 Days)
